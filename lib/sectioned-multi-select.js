...
// let date = new Date()
export class SectionedMultiSelect extends PureComponent {
  static propTypes = {
          ...
          <TouchableWithoutFeedback onPress={this._toggleSelector} disabled={this.state.selector}>
            ...
            >
              ...
              {selectToggleIconComponent ?
                selectToggleIconComponent
                :
                <View style={styles.buttonStyleGreen}>
